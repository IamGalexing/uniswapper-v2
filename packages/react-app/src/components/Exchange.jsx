  ...
  const onFromValueChange = (value) => {
    ...
    try {
      if (!value) {
        ...
        Number(value) ? setFromValue(value) : setFromValue("0");
      }
      // }
    } catch (error) {
      console.log(error);
    ...
    <div className='flex flex-col w-full items-center'>
      ...
      {approvedNeeded && !isSwapping ? (
        <button
          ...
          className={`${
            canApprove ? "bg-site-pink text-white" : "bg-site-dim2 text-dim2"
          } ${styles.actionButton}`}
        >
        ...
        <button
          ...
          className={`${
            canSwap ? "bg-site-pink text-white" : "bg-site-dim2 text-dim2"
          } ${styles.actionButton}`}
        >
          {isSwapping
            ? "Swapping..."
